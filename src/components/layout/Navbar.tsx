...
export const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'Education', path: '/education', icon: <BookOpen className="h-4 w-4 mr-2" /> },
    { name: 'Contact', path: '/contact', icon: <Mail className="h-4 w-4 mr-2" /> },
    { name: 'Game', path: '/game', icon: <Gamepad2 className="h-4 w-4 mr-2" /> },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'md:hidden fixed inset-0 top-16 bg-background/95 backdrop-blur-sm transform transition-transform duration-300 ease-in-out z-40',
